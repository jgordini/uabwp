 ...
 * Slug: uabwp/footer-default-dark
 * Categories: footer
...
<div class="wp-block-group alignfull has-background-color has-base-color has-contrast-background-color has-text-color has-background has-link-color has-small-font-size" style="margin-top:0px;padding-top:var(--wp--preset--spacing--small);padding-right:30px;padding-bottom:var(--wp--preset--spacing--small);padding-left:30px">
	...
	<div class="wp-block-group alignwide">
		<!-- wp:paragraph -->
		<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'uabwp' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'uabwp' ); ?></a></p>
		<!-- /wp:paragraph -->
		<!-- wp:paragraph -->
		<p><a href="#"><?php echo esc_html__( 'Facebook', 'uabwp' ); ?></a> · <a href="#"><?php echo esc_html__( 'LinkedIn', 'uabwp' ); ?></a> · <a href="#"><?php echo esc_html__( 'Instagram', 'uabwp' ); ?></a></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
