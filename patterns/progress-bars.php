...
<div class="wp-block-group">
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:100%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #1', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '100%', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:90%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #2', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '90%', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:80%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #3', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '80%', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:70%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #4', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '70%', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:60%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #5', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '60%', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:50%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #6', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '50%', 'uabwp' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
